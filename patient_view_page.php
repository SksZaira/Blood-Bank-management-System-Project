...
<script>
function saveinfo() {
			edit.action = "p_update_page.php?Name=<?php echo $a ?>";
			edit.submit();
	}
function cancel() {
	edit.action = "user_info.php";
	edit.submit();
	}
</script>
...
<form name="edit" action="" method="get">
 ...
 <tr >
  ...
  <tr >
    ...
    <td ><input type="text" name="name"  value="<?php  echo $f;?>"  style="width:200px; border-radius:2px; background-color:#F8F8F8;"  /></td>
  </tr>
   <tr >
 ...
 <tr >
    <td id="rr"><font face="Lucida Handwriting, italic" size="+1">Request Date</font></td>
