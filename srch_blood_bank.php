...
{
document.srch.c_name.value = document.srch.c_name.value.toUpperCase();
}

function check()
{
if(document.srch.c_name.value=="")
  {
    alert("Please Select City Name");
	document.srch.c_name.focus();
	return false;
  }
  }
</script>
...
<table  cellpadding="3" width="1150" border="0">
  <tr>
     ...
     <td rowspan="2">
   <form name="srch" method="get" action="blood_bank_list.php" onsubmit="return check();" >
<table id="srcha" border="0"cellpadding="10" width="450"  height="500">
    <tr>
    <td style="font-family:Algerian; font-size:36px; color:#990000;" colspan="2">Search Blood Bank</td>
    </tr>
  <tr>
    <td style="font-family:'Lucida Handwriting', italic; font-size:18px">City</td>
    <td><input type="text" name="c_name" onkeyup="makeUpperCase();" /> </td>
  </tr>
  <tr>
