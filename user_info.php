...
<table  id="user_menu_bar" align="left" width="150" border="1" cellpadding="1" frame="void " style='margin-top:50px;'>
  ...
  <tr>
   ...
   <tr>
   <td> <a href="change_password.html"><font color="#FFFFFF">CHANGE PASSWORD</font></a></td>
...
echo $_SESSION['u_name']; ?></u></font></td></tr>
	...
	<?php 
		...
		echo "<tr align='center' style='background-color:#FAA992; color:000000;'><td >",$r["Name"],"</td>
									...
									<td>",$r["MoblNo"],"</td>
									<td >",$r["Email"],"</td>
									<td><a href='user_view_page.php?Name=".$r["Name"],"'><input type='button' name='edit_button' value='Edit' style='height:30px; width:100px; border-radius:2px; font-size:16px; border-radius:5px; color:#000000;'/></a></td>
