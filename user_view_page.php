...
<script>
function saveinfo() {
			edit.action = "update_page.php?Name=<?php echo $a ?>";
			edit.submit();
	}
function cancel() {
	edit.action = "user_info.php?Name=<?php echo $a ?>";
	edit.submit();
	}
</script>
...
$record=mysql_query("select * from reg where Email='$p'");
...
<!--<div id="back" style="border:none;">
<a href="user_info.php"><input type="button" name="button" value="Back"  style="border-radius:solid 5px; width:150px; height:100; font:Georgia, 'Times New Roman', Times, serif; font-size:18px; color:#990000; float:left; margin-left:10px; margin-top:20px; "/></a>
</div>-->
...
<form name="edit" action="" method="get">
 ...
 <tr >
    ...
    <td><input type="text"  name="d_date" value="<?php echo $dd;?>"  disabled="disabled" style="width:200px; border-radius:2px; background-color:#F8F8F8;" /></td>
  </tr>
  ...
  <tr>                             
    ...
    <td ><input type="text"   style="width:200px; border-radius:2px;"  value="<?php echo $bb;?>"name="bank_name" .>
  </tr>
  <tr >
    <td id="rr"><font face="Lucida Handwriting, italic" size="+1">Location</font></td>
    <td ><input type="text"  style="width:200px; border-radius:2px;" value="<?php echo $bloc;?>"  /></td>
  </tr>
  
   <tr >
    <td id="rr"><font face="Lucida Handwriting, italic" size="+1">City</font></td>
    <td><input type="text" name="d_city"  style="width:200px; border-radius:2px;" value="<?php echo $bc;?>" /></td>
  </tr>
  
  <tr >
    <td id="rr"><font face="Lucida Handwriting, italic" size="+1">State</font></td>
    <td><input type="text" name="s_name" style="width:200px; border-radius:2px;" value="<?php echo $bs;?>" />
  
  </td></tr>
  <tr >
   <!-- <td><input style="font-size:16px" type="button" name="cancel"  value="Cancel" onClick="cancel();"/></td>
    <td><input style="font-size:16px" type="button" name="submit" value="Update"  onClick="saveinfo();" /></td>
  </tr>	-->	
  <td><input type="button" name="cancel" value="Cancel" style="border-radius:2px; height:35px; width:130px; font-size:16px; color:#FFFFFF; background:#000000;" onclick="cancel();"</td>
