...
<table border="1" width="400" cellspacing="0" cellpadding="4">
  <tr>
    ...
    <td>
     <a href="user_donor_detail.php"><input type="radio" name="regtn"  /><font face="Lucida Handwriting, italic" size="+1">Donor</font></a> <a href="user_patient_detail.php"><input type="radio" name="regtn"checked="checked" /><font face="Lucida Handwriting, italic" size="+1">Patient</font></a>
     </td
  ></tr>
</table>
</div>
...
<div id="fetch_donor_detail" style="float:right; margin-right:195px; width:700px; margin-top:10px;">
 <table  class="TFtable" width="300" height="40" cellpadding='1' border=0px>
		 ...
		 $b=$_GET['pass'];
		 echo "OKK....";*/
		$record=mysql_query("select * from p_reg") or die(mysql_error());
		...
		echo "<tr align='center' style='font-size:12px; color:000000;'><td >",$r["Name"],"</td>
									...
									<td>",$r["MoblNo"],"</td>
									<td >",$r["Email"],"</td>
									<td><a href='patient_delete_page.php?Email=".$r["Email"],"'><input type='button' name='d'value='Delete' style='border-radius:5px; background:#660066; color:#CCCCCC;'/></a></td>
									</tr>";
		}
	?>
