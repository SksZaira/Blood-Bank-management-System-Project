...
<table  cellpadding="3" width="1150" border="0">
  <tr>
     ...
     <tr>
        <td id="loga" colspan="2"><font  face="Algerian"> Patient Login</font> </tds>
        </tr>
     <tr>
...
if($p=='')
   ...
   {
	$que= "select * from p_reg where BINARY Email= BINARY '$n' and Password='$p'";
	...
	if(mysql_num_rows($run)==1)
	{
	   ...
	   echo "ok";
		header ('location:p_user_home.php');
...
<?php include $_SERVER['DOCUMENT_ROOT'].'/BloodBank_Project/include/footer.php'?>
