...
function cancel() {
	edit.action ="manage_blood_bank.php?Id=<?php echo $a ?>";
	edit.submit();
	}
	function saveinfo() {
			edit.action = "update_blood_bank.php?Id=<?php echo $a ?>";
			edit.submit();
	}
</script>
<script type="text/javascript">
function makeUppercase() {
document.edit.b_name.value = document.edit.b_name.value.toUpperCase();
document.edit.addr.value = document.edit.addr.value.toUpperCase();

document.edit.city.value = document.edit.city.value.toUpperCase();
document.edit.state.value = document.edit.state.value.toUpperCase();
document.edit.country.value = document.edit.country.value.toUpperCase();
